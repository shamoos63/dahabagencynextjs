...
const Header = () => {
  ...
  return (
    <>
<header
  className={`ud-header left-0 top-2 z-40 flex w-full items-center ${
    sticky
      ? "shadow-lg fixed z-[999] border-b border-stroke bg-white/80 backdrop-blur-[5px] dark:border-dark-3/20 dark:bg-dark/10 rounded-3xl px-8 py-2 transition-all ease-in-out duration-300"
      : "absolute bg-transparent rounded-3xl shadow-lg px-8 py-2 transition-all ease-in-out duration-300"
  }`}
>
